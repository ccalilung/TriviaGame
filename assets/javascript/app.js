   ...
   function go() {
       ...
       var questions = [{
           ...
           answer: "3",
           answerWord: "negative, hypothalamus, anterior pituitary",
           choices: {
           ...
           answer: "1",
           answerWord: "alanine, lysine, arginine",
           choices: {
       ...
       stop = function () {
           ...
           $("#question").html("Click to Restart Game");
       ...
       removeWrongAnswers = function () {
           ...
           if (a.val() === questions[f].answer) {
               a.remove();
               z.html("<h2>" + questions[f].answerWord + "</h2>")
           }
           if (b.val() === questions[f].answer) {
               b.remove();
               z.html("<h2>" + questions[f].answerWord + "</h2>")
       ...
       //show answer
       showAnswerCorrect = function () {
           //clear question and wrong choices out
           j.html("That is Correct!");
           removeWrongAnswers();
           setTimeout(correctAnswer, 3000);
       }

       showAnswerIncorrect = function () {
           //clear question and wrong choices out
           j.html("That is Incorrect!");
           removeWrongAnswers();
           setTimeout(incorrectAnswer, 3000);
       }
   ...
   function reset() {
        var a = $("#question")
        var b = $("<button>")
        b.attr("type","button").attr("id","go").addClass("btn btn-success").text("Start Game!");
        a.append("<br><br>",b);
